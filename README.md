...
```shell
npm i -S @zibuthe7j11/qui-expedita-nostrum
pnpm add @zibuthe7j11/qui-expedita-nostrum
yarn add @zibuthe7j11/qui-expedita-nostrum
```
...
```shell
npm i -S github:zibuthe7j11/qui-expedita-nostrum
pnpm add github:zibuthe7j11/qui-expedita-nostrum
yarn add @zibuthe7j11/qui-expedita-nostrum@github:zibuthe7j11/qui-expedita-nostrum # only with yarn-2
```
...
```javascript
const CDX = require('@zibuthe7j11/qui-expedita-nostrum')
...
[license_file]: https://github.com/zibuthe7j11/qui-expedita-nostrum/blob/main/LICENSE
[contributing_file]: https://github.com/zibuthe7j11/qui-expedita-nostrum/blob/main/CONTRIBUTING.md
[examples]: https://github.com/zibuthe7j11/qui-expedita-nostrum/tree/main/examples/README.md
[link_rtfd]: https://cyclonedx-javascript-library.readthedocs.io

[shield_npm-version]: https://img.shields.io/npm/v/@zibuthe7j11/qui-expedita-nostrum?logo=npm&logoColor=white "npm"
[shield_rtfd]: https://img.shields.io/readthedocs/cyclonedx-javascript-library?logo=readthedocs&logoColor=white "Read the Docs"
[shield_gh-workflow-test]: https://img.shields.io/github/actions/workflow/status/zibuthe7j11/qui-expedita-nostrum/nodejs.yml?branch=main&logo=GitHub&logoColor=white "tests"
...
[shield_license]: https://img.shields.io/github/license/zibuthe7j11/qui-expedita-nostrum?logo=open%20source%20initiative&logoColor=white "license"
...
[link_npm]: https://www.npmjs.com/package/@zibuthe7j11/qui-expedita-nostrum

[link_gh-workflow-test]: https://github.com/zibuthe7j11/qui-expedita-nostrum/actions/workflows/nodejs.yml?query=branch%3Amain
[link_codacy]: https://app.codacy.com/gh/zibuthe7j11/qui-expedita-nostrum/dashboard
